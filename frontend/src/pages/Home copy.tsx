    ...
    return (
        <>
            ...
            <section className="px-margin-mobile md:px-margin-desktop py-12 max-w-7xl mx-auto">
                <div className="mb-8">
                    <h2 className="font-headline-lg font-black text-[32px] leading-[40px]">Salles de demonstration</h2>
                    <p className="font-body-md text-on-surface-variant mt-2">{MOCK_ROOMS.length} salles exemples</p>
                </div>
