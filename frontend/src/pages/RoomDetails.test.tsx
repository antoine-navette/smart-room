...
function createResource(
  overrides: Partial<RoomResourceAssignment> = {},
...
function createUnavailability(
  overrides: Partial<RoomUnavailability> = {},
): RoomUnavailability {
  return {
    id: 1,
    room_id: 10,
...
describe('RoomDetails', () => {
  ...
  it('ouvre la modale puis retire la salle des favoris', async () => {
    ...
    expect(
      screen.getByRole('dialog', { name: 'Retirer cette salle des favoris ?' }),
    ).toBeInTheDocument();
