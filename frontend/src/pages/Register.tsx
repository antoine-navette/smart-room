      ...
      <div className="w-full max-w-lg space-y-8">
        <div className="text-center">
          <Link to="/" className="inline-block mb-6 group">
            <span className="font-headline-xl font-black text-5xl text-on-primary tracking-widest uppercase" style={{ textShadow: '4px 4px 0 #1a1c1c' }}>
              SmartRoom
            </span>
          </Link>
          <h2 className="font-headline-lg font-black text-[32px] text-surface-container-lowest uppercase">Créer un compte</h2>
          <p className="font-body-lg font-bold text-primary-fixed-dim mt-2">Rejoignez-nous pour gérer vos réservations</p>
        </div>
          ...
          <div className="p-8 space-y-6">
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="font-label-bold font-bold block mb-2 text-on-surface-variant">Nom</label>
                  <Input placeholder="Dupont" />
                </div>
                <div>
                  <label className="font-label-bold font-bold block mb-2 text-on-surface-variant">Prénom</label>
                  <Input placeholder="Jean" />
                </div>
              </div>

              <div>
                <label className="font-label-bold font-bold block mb-2 text-on-surface-variant">Email</label>
              ...
              <div>
                <label className="font-label-bold font-bold block mb-2 text-on-surface-variant">Genre</label>
                <div className="relative">
                  <Icon name="wc" className="absolute left-3 top-3 text-on-surface-variant pointer-events-none" />
            ...
            <div className="text-center mt-4">
              <Link to="/login" className="font-label-bold font-bold text-primary hover:underline">Déjà un compte ? Se connecter</Link>
            </div>
          </div>
        </div>

        <div className="text-center">
           <Link to="/" className="font-label-bold font-bold text-on-primary hover:underline">← Continuer sans se connecter</Link>
        </div>
      </div>
