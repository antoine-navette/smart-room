                    ...
                    <div className="bg-surface border-[3px] border-on-surface p-6 neo-shadow">
                        <div className="flex flex-col md:flex-row justify-between md:items-start gap-4">
                            ...
                            <div className="flex gap-4">
                                ...
                                <button
                                    className="w-12 h-12 flex items-center justify-center bg-surface border-[3px] border-on-surface neo-shadow-sm neo-active-sm hover:bg-secondary-container transition-colors"
