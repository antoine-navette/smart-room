...
export default function Navbar() {
    ...
    const userInitials = isAuthenticated ? `${user.first_name.charAt(0)}${user.last_name.charAt(0)}` : '';
        ...
        <nav className="sticky top-0 z-50 border-b-[3px] border-on-surface bg-surface shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
            <div className="relative mx-auto flex w-full max-w-full items-center justify-between px-margin-mobile py-gutter md:px-margin-desktop">
                <div className="flex items-center gap-4">
                    <Link to="/" aria-label="Retour à l'accueil SmartRoom">
                        <img
                            alt="SmartRoom Logo"
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    {isAuthenticated ? (
                        <NavLink to="/dashboard" className={getDesktopLinkClass(isDashboardActive)}>
                            Mes réservations
                        </NavLink>
                    ) : null}
                </div>
                ...
                {isMobileMenuOpen ? (
                    ...
                    >
                        <div className="flex flex-col gap-3">
                            <Link to="/" onClick={closeMobileMenu} className={getMobileLinkClass(isRoomsActive)}>
                                <span>Salles</span>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-body-md text-on-surface-variant">
                                            {isAdmin ? 'Administrateur' : 'Utilisateur connecté'}
                                        </p>
                                    </div>
                                </div>
