    ...
    return (
        <div className="md:col-span-4 flex flex-col gap-gutter">
            <div className="bg-secondary-container p-6 border-[3px] border-on-surface neo-shadow flex flex-col items-center justify-center text-center">
                ...
                <p className="font-label-bold font-bold text-on-surface-variant uppercase tracking-wide">
                    Salles réservées ce mois-ci
                </p>
            </div>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="font-body-md text-on-surface-variant text-sm">
                                Salle Alpha réservée pour 10h00
                            </p>
                        </div>
                    </div>
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="font-body-md text-on-surface-variant text-sm">
                                La Salle C requiert votre attention.
                            </p>
                        </div>
                    </div>
                </div>
