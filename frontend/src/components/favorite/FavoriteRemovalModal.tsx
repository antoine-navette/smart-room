    ...
    return (
        ...
        >
            <div className="border-[3px] border-on-surface bg-surface-container-lowest p-4">
                <p className="font-label-bold font-bold uppercase text-on-surface-variant">Salle concernée</p>
                <p className="mt-2 font-headline-md font-bold text-[24px] text-on-surface">{roomName}</p>
                {location ? <p className="mt-1 font-body-md text-on-surface-variant">{location}</p> : null}
            </div>
        </Modal>
    );
}
